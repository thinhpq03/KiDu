...
extension PixelArtViewModel {
    func defaultGrayForPixel(_ pixel: Pixel) -> UIColor {
        return quantizedGray(from: pixel.paletteColor)
    }
}

extension UIColor {
    func isApproximatelyEqual(to color: UIColor, tolerance: CGFloat = 0.01) -> Bool {
